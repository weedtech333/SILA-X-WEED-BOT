...
cmd({
  ...
  alias: ["newsletter", "id"],
  react: "📡",
  desc: "https://whatsapp.com/channel/0029Vb2J9C91dAw7vxA75y2V",
  category: "whatsapp",
  filename: __filename
}, async (conn, mek, m, {
  from,
  ...
  try {
    if (!q) return reply("❎ Please provide a WhatsApp Channel link.\n\n*Example:* .cinfo https://whatsapp.com/channel/0029Vb2J9C91dAw7vxA75y2V/123456789");

    const match = q.match(/whatsapp\.com\/channel\/([\w-]+)/);
    if (!match) return reply("⚠️ *Invalid channel link format.*\n\nMake sure it looks like:\https://whatsapp.com/channel/0029Vb2J9C91dAw7vxA75y2V");
    ...
    if (metadata.preview) {
      await conn.sendMessage(from, {
        image: { url: `https://whatsapp.com/channel/0029Vb2J9C91dAw7vxA75y2V.net${metadata.preview}` },
        caption: infoText
      }, { quoted: m });
    } else {
